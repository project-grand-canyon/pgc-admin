...
class EditCaller extends Component {
    ...
    render() {
        return (<>
            {this.form()}
            <Button disabled={this.state.saving} style={{margin: "4px"}} onClick={this.handleCancel}>Cancel</Button>
            <Button disabled={this.state.saving} style={{margin: "4px"}} onClick={this.handleSave} type="primary">Save</Button>
        </>);
